 ...
 *     \li playUntilEnd
 *
 *  \author Nuno Pão d'Lau - January 2021
 */
...
static int goalieConstituteTeam (int id)
{
    ...
    else if (sh->fSt.playersFree<4 && sh->fSt.goaliesArrived <= 2*NUMTEAMGOALIES){ //sh->fSt.goaliesArrived < 3 porque o 3º redes a chegar não pode esperar pela equipa, vai direto para o estado "LATE"
